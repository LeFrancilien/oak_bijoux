    ...
    return (
        <div className="min-h-screen bg-stone-50 dark:bg-onyx-950 font-sans text-onyx-900 dark:text-stone-100">
            ...
            <div className="max-w-4xl mx-auto px-6 py-12 relative z-10">
                ...
                <div className="bg-white dark:bg-onyx-900 rounded-xl shadow-xl shadow-gold-500/5 dark:shadow-none p-8 md:p-12 border border-gold-200/50 dark:border-gold-500/10">
                    <div className="
            ...
            [&_p]:mb-4 [&_p]:leading-relaxed [&_p]:text-[#374151] dark:[&_p]:text-[#d1d5db]
            [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-6 [&_ul]:space-y-2 [&_ul]:text-[#374151] dark:[&_ul]:text-[#d1d5db]
            [&_li]:marker:text-gold-500
            [&_strong]:font-semibold [&_strong]:text-[#111827] dark:[&_strong]:text-white
