...
export default function LegalLayout({
    ...
    return (
        <div className="min-h-screen bg-stone-50 dark:bg-onyx-950 font-sans text-onyx-900 dark:text-stone-100">
            ...
            [&_p]:mb-4 [&_p]:leading-relaxed [&_p]:text-gray-800 dark:[&_p]:text-gray-200
            [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-6 [&_ul]:space-y-2 [&_ul]:text-gray-800 dark:[&_ul]:text-gray-200
